...
class StopwatchWatchScreen extends StatefulWidget {
  const StopwatchWatchScreen({super.key});

  @override
  State<StopwatchWatchScreen> createState() => _StopwatchWatchScreenState();
}

class _StopwatchWatchScreenState extends State<StopwatchWatchScreen> {
  List<String> laps = [];
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Visibility(
                        visible: isStopWatchRunning == true ||
                            lapStopWatchInMilliseconds != 0,
                        child: Padding(
